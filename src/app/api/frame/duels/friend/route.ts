...
function getResponse(type: ResponseType) {
	const IMAGE = {
		[ResponseType.SUCCESS]: 'https://gateway.lighthouse.storage/ipfs/bafybeidot3ebld6cylwsb6h2elpwzskpe77oduqau6dx7zxxmi35zhbc7a/Duel-friend.gif',
	...
	<meta name="fc:frame:input:text" content="Write handle your friend..." />

	<meta name="fc:frame:button:1" content="Enter Duel" />
	<meta name="fc:frame:button:1:action" content="post" />
	<meta name="fc:frame:button:1:target" content="${SITE_URL}/api/frame/choice/" />
